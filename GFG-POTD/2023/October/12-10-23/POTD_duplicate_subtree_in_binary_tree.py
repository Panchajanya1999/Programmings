...
class Node:
    def _init_(self,val):
        ...
        '''
class Solution:
    def subtreeval(self, root, sub_tree):
        if root is None:
            return '#'
        
        sub_string = str(root.data) + self.subtreeval(root.left, sub_tree) + self.subtreeval(root.right, sub_tree)
